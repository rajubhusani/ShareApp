...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUberBtn = (ImageButton) findViewById(R.id.uberBtn);
        mGmailBtn = (ImageButton) findViewById(R.id.gmailBtn);
    ...
    public void onClick(View view) {
        ...
        switch (id){
            case R.id.twitterBtn:
                Intent intent = new Intent(MainActivity.this, TwitterOAuthAct.class);
                startActivity(intent);
                break;
            case R.id.uberBtn:
                Intent uberIntent = new Intent(MainActivity.this, UberActivity.class);
                startActivity(uberIntent);
                break;
            case R.id.gmailBtn:
                Intent gmailIntent = new Intent(MainActivity.this, GmailActivity.class);

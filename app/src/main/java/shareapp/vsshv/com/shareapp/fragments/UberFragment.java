...
import shareapp.vsshv.com.shareapp.adapters.UberAdapter;
...
public class UberFragment extends Fragment {
    ...
    private void getActivities(){
        ...
        List<UberDataSet> arrayList = dao.getAllUMessages();
        Log.d("","=====getActivities=");
        if(arrayList != null && arrayList.size() > 0){
            UberAdapter mList = new UberAdapter(arrayList, getActivity());
